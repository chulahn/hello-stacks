...
const steps = ['Shipping address', 'Document Upload', 'Review your order'];
          ...
          >
            ...
            {activeStep === steps.length ? (
              <Stack spacing={2} useFlexGap>
                ...
                <Typography variant="h5">Your information has been saved!</Typography>
                ...
                <Typography>
                    Your secret is mX58pdORv17MfFAgxpFq
                </Typography>
                <Button
                  variant="contained"
                  sx={{
